...
public class IngredienteService {
	...
	public void sendEmailForAdmin(Ingrediente r) throws Exception {
		String corpo = "Ingrediente com id: " + r.getId() + " encontra-se pendente de aprovação.";
		String assunto = "Ingrediente pendente de aprovação";
